...
export function buildGameState(
  ...
  return {
    ...
    modifiers: {
      ...
      meleeKillHeal: 0,
      counterAlwaysCrit: false,
      rangedAlwaysHit: false,
      guaranteedLegendaryDraws: 0,
      phoenixActive: false,
      berserkerBonus: 0,
    },
    housePicks: {
 ...
 */
export const ANIMATED_HERO_TEST_STAGE: ChapterDef = {
  id: 'animated-hero-test-stage',
  name: 'Hero Animation Test',
