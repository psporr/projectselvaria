 ...
 */
import { CAMPAIGN_CHAPTER_1, CAMPAIGN_CHAPTER_2, ANIMATED_HERO_TEST_STAGE, ROGUELIKE_MAPS, type ChapterDef } from '../game/maps';
...
const CHAPTERS: ChapterDef[] = [CAMPAIGN_CHAPTER_1, CAMPAIGN_CHAPTER_2, ...ROGUELIKE_MAPS, ANIMATED_HERO_TEST_STAGE];
