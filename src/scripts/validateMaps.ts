 ...
 */
import { CAMPAIGN_CHAPTER_1, CAMPAIGN_CHAPTER_2, CHAPTER_1, TEST_MAP_1, type ChapterDef } from '../game/maps';
...
const CHAPTERS: ChapterDef[] = [CHAPTER_1, CAMPAIGN_CHAPTER_1, CAMPAIGN_CHAPTER_2, TEST_MAP_1];
