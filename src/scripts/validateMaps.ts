 ...
 */
import { CAMPAIGN_CHAPTER_1, CAMPAIGN_CHAPTER_2, CHAPTER_1, ANIMATED_HERO_TEST_STAGE, TEST_MAP_1, TEST_MAP_1_DETAILED, TEST_MAP_2, type ChapterDef } from '../game/maps';
...
const CHAPTERS: ChapterDef[] = [CHAPTER_1, CAMPAIGN_CHAPTER_1, CAMPAIGN_CHAPTER_2, TEST_MAP_1, TEST_MAP_1_DETAILED, TEST_MAP_2, ANIMATED_HERO_TEST_STAGE];
