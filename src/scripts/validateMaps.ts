 ...
 */
import { CAMPAIGN_CHAPTER_1, CAMPAIGN_CHAPTER_2, ANIMATED_HERO_TEST_STAGE, RIVER_CROSSING, type ChapterDef } from '../game/maps';
...
const CHAPTERS: ChapterDef[] = [CAMPAIGN_CHAPTER_1, CAMPAIGN_CHAPTER_2, RIVER_CROSSING, ANIMATED_HERO_TEST_STAGE];
