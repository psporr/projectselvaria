...
export const CLASS_LETTER: Record<ClassName, string> = {
  ...
  // added 2026-09-04) — only ever shown as a fallback if the animated
  // sprite atlas fails to load; the unit otherwise always renders its real
  // animated art (heroArt.ts's ANIMATED_HERO_NAMES).
  Luffy: 'Y',
  Zoro: 'J',
  Gear5: 'Q',
};
